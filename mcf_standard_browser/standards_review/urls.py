...
urlpatterns = [
    ...
    url(r'^MS2/export/single/$', views.fragmentSpectrum_export, name='fragmentSpectrum-export'),
    url(r'^MS2/export/formats/$', views.fragmentSpectrum_export, name='fragmentSpectrumExportFormats'),
    url(r'^MS2/export/format/(?P<fmt>.+)/$', views.fragmentSpectrumExport, name='fragmentSpectrumExport'),
    url(r'^MS2/export/zip/$', views.fragmentSpectrum_export, name='fragmentSpectrum-export'),
