...
urlpatterns = [
    ...
    url(r'^adduct/add/$', views.MCFAdduct_add, name='adduct-add'),
    url(r'^inventory/$', views.MCFStandard_list, name='standard-list'),
    url(r'^inventory/add/$', views.MCFStandard_add, name='standard-add'),
    url(r'^inventory/add/batch/$', views.MCFStandard_add_batch, name='standard-add-batch'),
    url(r'^inventory/MCF(?P<pk>.+)/$', views.MCFStandard_detail, name='standard-detail'),
    url(r'^inventory/edit/MCF(?P<pk>.+)/$', views.MCFStandard_edit, name='standard-edit'),
    url(r'^molecule/edit/(?P<pk>.+)/$', views.MCFMolecule_edit, name='molecule-edit'),
    url(r'^molecule/add/$', views.MCFMolecule_add, name='molecule-add'),
    url(r'^molecule/cleandb/$', views.MCFMolecule_cleandb, name='molecule-cleandb'),
    url(r'^molecule/(?P<pk>.+)/$', views.MCFMolecule_detail, name='molecule-detail'),
    url(r'^molecule/$', views.MCFMolecule_list, name='molecule-list'),
    ...
    url(r'^dataset/$', views.MCFdataset_list, name='dataset-list'),
    url(r'^dataset/(?P<pk>.+)/$', views.MCFdataset_detail, name='dataset-detail'),
